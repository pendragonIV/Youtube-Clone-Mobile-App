...
//    private ActivityMainBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.listfavor);
        ...
        Cursor getVid = database.GetData("SELECT * FROM Favorite JOIN Video ON Favorite.Id_video = video.Id_video Where User_id = "+userID+" ORDER BY Id_favorite DESC");
